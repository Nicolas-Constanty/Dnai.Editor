...
curl -X PUT --data-binary "$dmg_path$dmg_name"  https://api.preprod.dnai.io/download/softwares/mac/$id/$release_version -H "authorization: Bearer $token" -H 'cache-control: no-cache' -H 'content-type: text/plain' -H 'postman-token: c8638d15-6169-9fb9-2bb3-6314e0d66b45'
