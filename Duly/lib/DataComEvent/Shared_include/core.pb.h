...
// source: core_reply.proto

#ifndef PROTOBUF_core_5freply_2eproto__INCLUDED
#define PROTOBUF_core_5freply_2eproto__INCLUDED
...
class EntityDeclared;
class EntityDeclaredDefaultTypeInternal;
extern EntityDeclaredDefaultTypeInternal _EntityDeclared_default_instance_;
...
namespace protobuf_core_5freply_2eproto {
...
class AddClassAttribute : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:AddClassAttribute) */ {
 ...
 private:
  ...
  friend struct protobuf_core_5freply_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Commands : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Commands) */ {
 public:
  Commands();
  virtual ~Commands();
  ...
  inline Commands* New() const PROTOBUF_FINAL { return New(NULL); }

  Commands* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class EntityDeclared : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:EntityDeclared) */ {
 public:
  EntityDeclared();
  virtual ~EntityDeclared();

  EntityDeclared(const EntityDeclared& from);

  inline EntityDeclared& operator=(const EntityDeclared& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const EntityDeclared& default_instance();

  static inline const EntityDeclared* internal_default_instance() {
    return reinterpret_cast<const EntityDeclared*>(
               &_EntityDeclared_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    8;

  void Swap(EntityDeclared* other);

  // implements Message ----------------------------------------------

  inline EntityDeclared* New() const PROTOBUF_FINAL { return New(NULL); }

  EntityDeclared* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const EntityDeclared& from);
  void MergeFrom(const EntityDeclared& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(EntityDeclared* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  const ::Declare& command() const;
  ::Declare* mutable_command();
  ::Declare* release_command();
  void set_allocated_command(::Declare* command);
  ...
  // @@protoc_insertion_point(class_scope:EntityDeclared)
 private:
...
class ProtoData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ProtoData) */ {
 public:
  ProtoData();
  virtual ~ProtoData();
  ...
  void set_allocated_commands(::Commands* commands);

  // .Replies Replies = 2;
  bool has_replies() const;
  void clear_replies();
  static const int kRepliesFieldNumber = 2;
  const ::Replies& replies() const;
  ::Replies* mutable_replies();
  ::Replies* release_replies();
  void set_allocated_replies(::Replies* replies);
...
class Replies : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Replies) */ {
 public:
  Replies();
  virtual ~Replies();
  ...
  inline Replies* New() const PROTOBUF_FINAL { return New(NULL); }

  Replies* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  // .EntityDeclared EntityDeclared = 1;
  bool has_entitydeclared() const;
  void clear_entitydeclared();
  static const int kEntityDeclaredFieldNumber = 1;
  const ::EntityDeclared& entitydeclared() const;
  ::EntityDeclared* mutable_entitydeclared();
  ::EntityDeclared* release_entitydeclared();
  void set_allocated_entitydeclared(::EntityDeclared* entitydeclared);

  // @@protoc_insertion_point(class_scope:Replies)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::EntityDeclared* entitydeclared_;
  mutable int _cached_size_;
  friend struct protobuf_core_5freply_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class SetInstructionInputValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SetInstructionInputValue) */ {
 public:
  ...
  void set_inputvalue(const ::std::string& value);
  #if LANG_CXX11
  void set_inputvalue(::std::string&& value);
  #endif
  void set_inputvalue(const char* value);
  void set_inputvalue(const char* value, size_t size);
  ::std::string* mutable_inputvalue();
  ::std::string* release_inputvalue();
  void set_allocated_inputvalue(::std::string* inputvalue);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr inputname_;
  ::google::protobuf::internal::ArenaStringPtr inputvalue_;
  ::google::protobuf::uint32 functionid_;
  ::google::protobuf::uint32 instruction_;
  mutable int _cached_size_;
  friend struct protobuf_core_5freply_2eproto::TableStruct;
...
// .Declare Declare = 1;
inline bool Commands::has_declare() const {
  return this != internal_default_instance() && declare_ != NULL;
}
inline void Commands::clear_declare() {
  if (GetArenaNoVirtual() == NULL && declare_ != NULL) delete declare_;
  declare_ = NULL;
}
inline const ::Declare& Commands::declare() const {
  // @@protoc_insertion_point(field_get:Commands.Declare)
  return declare_ != NULL ? *declare_
                         : *::Declare::internal_default_instance();
}
inline ::Declare* Commands::mutable_declare() {
  
  if (declare_ == NULL) {
    declare_ = new ::Declare;
  }
  // @@protoc_insertion_point(field_mutable:Commands.Declare)
  return declare_;
}
inline ::Declare* Commands::release_declare() {
  // @@protoc_insertion_point(field_release:Commands.Declare)
  
  ::Declare* temp = declare_;
  declare_ = NULL;
  return temp;
}
inline void Commands::set_allocated_declare(::Declare* declare) {
  delete declare_;
  declare_ = declare;
  if (declare) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.Declare)
}

// .Remove Remove = 2;
inline bool Commands::has_remove() const {
  return this != internal_default_instance() && remove_ != NULL;
}
inline void Commands::clear_remove() {
  if (GetArenaNoVirtual() == NULL && remove_ != NULL) delete remove_;
  remove_ = NULL;
}
inline const ::Remove& Commands::remove() const {
  // @@protoc_insertion_point(field_get:Commands.Remove)
  return remove_ != NULL ? *remove_
                         : *::Remove::internal_default_instance();
}
inline ::Remove* Commands::mutable_remove() {
  
  if (remove_ == NULL) {
    remove_ = new ::Remove;
  }
  // @@protoc_insertion_point(field_mutable:Commands.Remove)
  return remove_;
}
inline ::Remove* Commands::release_remove() {
  // @@protoc_insertion_point(field_release:Commands.Remove)
  
  ::Remove* temp = remove_;
  remove_ = NULL;
  return temp;
}
inline void Commands::set_allocated_remove(::Remove* remove) {
  delete remove_;
  remove_ = remove;
  if (remove) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.Remove)
}

// .Rename Rename = 3;
inline bool Commands::has_rename() const {
  return this != internal_default_instance() && rename_ != NULL;
}
inline void Commands::clear_rename() {
  if (GetArenaNoVirtual() == NULL && rename_ != NULL) delete rename_;
  rename_ = NULL;
}
inline const ::Rename& Commands::rename() const {
  // @@protoc_insertion_point(field_get:Commands.Rename)
  return rename_ != NULL ? *rename_
                         : *::Rename::internal_default_instance();
}
inline ::Rename* Commands::mutable_rename() {
  
  if (rename_ == NULL) {
    rename_ = new ::Rename;
  }
  // @@protoc_insertion_point(field_mutable:Commands.Rename)
  return rename_;
}
inline ::Rename* Commands::release_rename() {
  // @@protoc_insertion_point(field_release:Commands.Rename)
  
  ::Rename* temp = rename_;
  rename_ = NULL;
  return temp;
}
inline void Commands::set_allocated_rename(::Rename* rename) {
  delete rename_;
  rename_ = rename;
  if (rename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.Rename)
}

// .Move Move = 4;
inline bool Commands::has_move() const {
  return this != internal_default_instance() && move_ != NULL;
}
inline void Commands::clear_move() {
  if (GetArenaNoVirtual() == NULL && move_ != NULL) delete move_;
  move_ = NULL;
}
inline const ::Move& Commands::move() const {
  // @@protoc_insertion_point(field_get:Commands.Move)
  return move_ != NULL ? *move_
                         : *::Move::internal_default_instance();
}
inline ::Move* Commands::mutable_move() {
  
  if (move_ == NULL) {
    move_ = new ::Move;
  }
  // @@protoc_insertion_point(field_mutable:Commands.Move)
  return move_;
}
inline ::Move* Commands::release_move() {
  // @@protoc_insertion_point(field_release:Commands.Move)
  
  ::Move* temp = move_;
  move_ = NULL;
  return temp;
}
inline void Commands::set_allocated_move(::Move* move) {
  delete move_;
  move_ = move;
  if (move) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.Move)
}

// .ChangeVisibility ChangeVisibility = 5;
inline bool Commands::has_changevisibility() const {
  return this != internal_default_instance() && changevisibility_ != NULL;
}
inline void Commands::clear_changevisibility() {
  if (GetArenaNoVirtual() == NULL && changevisibility_ != NULL) delete changevisibility_;
  changevisibility_ = NULL;
}
inline const ::ChangeVisibility& Commands::changevisibility() const {
  // @@protoc_insertion_point(field_get:Commands.ChangeVisibility)
  return changevisibility_ != NULL ? *changevisibility_
                         : *::ChangeVisibility::internal_default_instance();
}
inline ::ChangeVisibility* Commands::mutable_changevisibility() {
  
  if (changevisibility_ == NULL) {
    changevisibility_ = new ::ChangeVisibility;
  }
  // @@protoc_insertion_point(field_mutable:Commands.ChangeVisibility)
  return changevisibility_;
}
inline ::ChangeVisibility* Commands::release_changevisibility() {
  // @@protoc_insertion_point(field_release:Commands.ChangeVisibility)
  
  ::ChangeVisibility* temp = changevisibility_;
  changevisibility_ = NULL;
  return temp;
}
inline void Commands::set_allocated_changevisibility(::ChangeVisibility* changevisibility) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.ChangeVisibility)
}

// .SetVariableValue SetVariableValue = 6;
inline bool Commands::has_setvariablevalue() const {
  return this != internal_default_instance() && setvariablevalue_ != NULL;
}
inline void Commands::clear_setvariablevalue() {
  if (GetArenaNoVirtual() == NULL && setvariablevalue_ != NULL) delete setvariablevalue_;
  setvariablevalue_ = NULL;
}
inline const ::SetVariableValue& Commands::setvariablevalue() const {
  // @@protoc_insertion_point(field_get:Commands.SetVariableValue)
  return setvariablevalue_ != NULL ? *setvariablevalue_
                         : *::SetVariableValue::internal_default_instance();
}
inline ::SetVariableValue* Commands::mutable_setvariablevalue() {
  
  if (setvariablevalue_ == NULL) {
    setvariablevalue_ = new ::SetVariableValue;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetVariableValue)
  return setvariablevalue_;
}
inline ::SetVariableValue* Commands::release_setvariablevalue() {
  // @@protoc_insertion_point(field_release:Commands.SetVariableValue)
  
  ::SetVariableValue* temp = setvariablevalue_;
  setvariablevalue_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setvariablevalue(::SetVariableValue* setvariablevalue) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetVariableValue)
}

// .SetVariableType SetVariableType = 7;
inline bool Commands::has_setvariabletype() const {
  return this != internal_default_instance() && setvariabletype_ != NULL;
}
inline void Commands::clear_setvariabletype() {
  if (GetArenaNoVirtual() == NULL && setvariabletype_ != NULL) delete setvariabletype_;
  setvariabletype_ = NULL;
}
inline const ::SetVariableType& Commands::setvariabletype() const {
  // @@protoc_insertion_point(field_get:Commands.SetVariableType)
  return setvariabletype_ != NULL ? *setvariabletype_
                         : *::SetVariableType::internal_default_instance();
}
inline ::SetVariableType* Commands::mutable_setvariabletype() {
  
  if (setvariabletype_ == NULL) {
    setvariabletype_ = new ::SetVariableType;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetVariableType)
  return setvariabletype_;
}
inline ::SetVariableType* Commands::release_setvariabletype() {
  // @@protoc_insertion_point(field_release:Commands.SetVariableType)
  
  ::SetVariableType* temp = setvariabletype_;
  setvariabletype_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setvariabletype(::SetVariableType* setvariabletype) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetVariableType)
}

// .GetVariableValue GetVariableValue = 8;
inline bool Commands::has_getvariablevalue() const {
  return this != internal_default_instance() && getvariablevalue_ != NULL;
}
inline void Commands::clear_getvariablevalue() {
  if (GetArenaNoVirtual() == NULL && getvariablevalue_ != NULL) delete getvariablevalue_;
  getvariablevalue_ = NULL;
}
inline const ::GetVariableValue& Commands::getvariablevalue() const {
  // @@protoc_insertion_point(field_get:Commands.GetVariableValue)
  return getvariablevalue_ != NULL ? *getvariablevalue_
                         : *::GetVariableValue::internal_default_instance();
}
inline ::GetVariableValue* Commands::mutable_getvariablevalue() {
  
  if (getvariablevalue_ == NULL) {
    getvariablevalue_ = new ::GetVariableValue;
  }
  // @@protoc_insertion_point(field_mutable:Commands.GetVariableValue)
  return getvariablevalue_;
}
inline ::GetVariableValue* Commands::release_getvariablevalue() {
  // @@protoc_insertion_point(field_release:Commands.GetVariableValue)
  
  ::GetVariableValue* temp = getvariablevalue_;
  getvariablevalue_ = NULL;
  return temp;
}
inline void Commands::set_allocated_getvariablevalue(::GetVariableValue* getvariablevalue) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.GetVariableValue)
}

// .SetContextParent SetContextParent = 9;
inline bool Commands::has_setcontextparent() const {
  return this != internal_default_instance() && setcontextparent_ != NULL;
}
inline void Commands::clear_setcontextparent() {
  if (GetArenaNoVirtual() == NULL && setcontextparent_ != NULL) delete setcontextparent_;
  setcontextparent_ = NULL;
}
inline const ::SetContextParent& Commands::setcontextparent() const {
  // @@protoc_insertion_point(field_get:Commands.SetContextParent)
  return setcontextparent_ != NULL ? *setcontextparent_
                         : *::SetContextParent::internal_default_instance();
}
inline ::SetContextParent* Commands::mutable_setcontextparent() {
  
  if (setcontextparent_ == NULL) {
    setcontextparent_ = new ::SetContextParent;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetContextParent)
  return setcontextparent_;
}
inline ::SetContextParent* Commands::release_setcontextparent() {
  // @@protoc_insertion_point(field_release:Commands.SetContextParent)
  
  ::SetContextParent* temp = setcontextparent_;
  setcontextparent_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setcontextparent(::SetContextParent* setcontextparent) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetContextParent)
}

// .SetEnumerationType SetEnumerationType = 10;
inline bool Commands::has_setenumerationtype() const {
  return this != internal_default_instance() && setenumerationtype_ != NULL;
}
inline void Commands::clear_setenumerationtype() {
  if (GetArenaNoVirtual() == NULL && setenumerationtype_ != NULL) delete setenumerationtype_;
  setenumerationtype_ = NULL;
}
inline const ::SetEnumerationType& Commands::setenumerationtype() const {
  // @@protoc_insertion_point(field_get:Commands.SetEnumerationType)
  return setenumerationtype_ != NULL ? *setenumerationtype_
                         : *::SetEnumerationType::internal_default_instance();
}
inline ::SetEnumerationType* Commands::mutable_setenumerationtype() {
  
  if (setenumerationtype_ == NULL) {
    setenumerationtype_ = new ::SetEnumerationType;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetEnumerationType)
  return setenumerationtype_;
}
inline ::SetEnumerationType* Commands::release_setenumerationtype() {
  // @@protoc_insertion_point(field_release:Commands.SetEnumerationType)
  
  ::SetEnumerationType* temp = setenumerationtype_;
  setenumerationtype_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setenumerationtype(::SetEnumerationType* setenumerationtype) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetEnumerationType)
}

// .SetEnumerationValue SetEnumerationValue = 11;
inline bool Commands::has_setenumerationvalue() const {
  return this != internal_default_instance() && setenumerationvalue_ != NULL;
}
inline void Commands::clear_setenumerationvalue() {
  if (GetArenaNoVirtual() == NULL && setenumerationvalue_ != NULL) delete setenumerationvalue_;
  setenumerationvalue_ = NULL;
}
inline const ::SetEnumerationValue& Commands::setenumerationvalue() const {
  // @@protoc_insertion_point(field_get:Commands.SetEnumerationValue)
  return setenumerationvalue_ != NULL ? *setenumerationvalue_
                         : *::SetEnumerationValue::internal_default_instance();
}
inline ::SetEnumerationValue* Commands::mutable_setenumerationvalue() {
  
  if (setenumerationvalue_ == NULL) {
    setenumerationvalue_ = new ::SetEnumerationValue;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetEnumerationValue)
  return setenumerationvalue_;
}
inline ::SetEnumerationValue* Commands::release_setenumerationvalue() {
  // @@protoc_insertion_point(field_release:Commands.SetEnumerationValue)
  
  ::SetEnumerationValue* temp = setenumerationvalue_;
  setenumerationvalue_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setenumerationvalue(::SetEnumerationValue* setenumerationvalue) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetEnumerationValue)
}

// .GetEnumerationValue GetEnumerationValue = 12;
inline bool Commands::has_getenumerationvalue() const {
  return this != internal_default_instance() && getenumerationvalue_ != NULL;
}
inline void Commands::clear_getenumerationvalue() {
  if (GetArenaNoVirtual() == NULL && getenumerationvalue_ != NULL) delete getenumerationvalue_;
  getenumerationvalue_ = NULL;
}
inline const ::GetEnumerationValue& Commands::getenumerationvalue() const {
  // @@protoc_insertion_point(field_get:Commands.GetEnumerationValue)
  return getenumerationvalue_ != NULL ? *getenumerationvalue_
                         : *::GetEnumerationValue::internal_default_instance();
}
inline ::GetEnumerationValue* Commands::mutable_getenumerationvalue() {
  
  if (getenumerationvalue_ == NULL) {
    getenumerationvalue_ = new ::GetEnumerationValue;
  }
  // @@protoc_insertion_point(field_mutable:Commands.GetEnumerationValue)
  return getenumerationvalue_;
}
inline ::GetEnumerationValue* Commands::release_getenumerationvalue() {
  // @@protoc_insertion_point(field_release:Commands.GetEnumerationValue)
  
  ::GetEnumerationValue* temp = getenumerationvalue_;
  getenumerationvalue_ = NULL;
  return temp;
}
inline void Commands::set_allocated_getenumerationvalue(::GetEnumerationValue* getenumerationvalue) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.GetEnumerationValue)
}

// .RemoveEnumerationValue RemoveEnumerationValue = 13;
inline bool Commands::has_removeenumerationvalue() const {
  return this != internal_default_instance() && removeenumerationvalue_ != NULL;
}
inline void Commands::clear_removeenumerationvalue() {
  if (GetArenaNoVirtual() == NULL && removeenumerationvalue_ != NULL) delete removeenumerationvalue_;
  removeenumerationvalue_ = NULL;
}
inline const ::RemoveEnumerationValue& Commands::removeenumerationvalue() const {
  // @@protoc_insertion_point(field_get:Commands.RemoveEnumerationValue)
  return removeenumerationvalue_ != NULL ? *removeenumerationvalue_
                         : *::RemoveEnumerationValue::internal_default_instance();
}
inline ::RemoveEnumerationValue* Commands::mutable_removeenumerationvalue() {
  
  if (removeenumerationvalue_ == NULL) {
    removeenumerationvalue_ = new ::RemoveEnumerationValue;
  }
  // @@protoc_insertion_point(field_mutable:Commands.RemoveEnumerationValue)
  return removeenumerationvalue_;
}
inline ::RemoveEnumerationValue* Commands::release_removeenumerationvalue() {
  // @@protoc_insertion_point(field_release:Commands.RemoveEnumerationValue)
  
  ::RemoveEnumerationValue* temp = removeenumerationvalue_;
  removeenumerationvalue_ = NULL;
  return temp;
}
inline void Commands::set_allocated_removeenumerationvalue(::RemoveEnumerationValue* removeenumerationvalue) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.RemoveEnumerationValue)
}

// .AddClassAttribute AddClassAttribute = 14;
inline bool Commands::has_addclassattribute() const {
  return this != internal_default_instance() && addclassattribute_ != NULL;
}
inline void Commands::clear_addclassattribute() {
  if (GetArenaNoVirtual() == NULL && addclassattribute_ != NULL) delete addclassattribute_;
  addclassattribute_ = NULL;
}
inline const ::AddClassAttribute& Commands::addclassattribute() const {
  // @@protoc_insertion_point(field_get:Commands.AddClassAttribute)
  return addclassattribute_ != NULL ? *addclassattribute_
                         : *::AddClassAttribute::internal_default_instance();
}
inline ::AddClassAttribute* Commands::mutable_addclassattribute() {
  
  if (addclassattribute_ == NULL) {
    addclassattribute_ = new ::AddClassAttribute;
  }
  // @@protoc_insertion_point(field_mutable:Commands.AddClassAttribute)
  return addclassattribute_;
}
inline ::AddClassAttribute* Commands::release_addclassattribute() {
  // @@protoc_insertion_point(field_release:Commands.AddClassAttribute)
  
  ::AddClassAttribute* temp = addclassattribute_;
  addclassattribute_ = NULL;
  return temp;
}
inline void Commands::set_allocated_addclassattribute(::AddClassAttribute* addclassattribute) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.AddClassAttribute)
}

// .RenameClassAttribute RenameClassAttribute = 15;
inline bool Commands::has_renameclassattribute() const {
  return this != internal_default_instance() && renameclassattribute_ != NULL;
}
inline void Commands::clear_renameclassattribute() {
  if (GetArenaNoVirtual() == NULL && renameclassattribute_ != NULL) delete renameclassattribute_;
  renameclassattribute_ = NULL;
}
inline const ::RenameClassAttribute& Commands::renameclassattribute() const {
  // @@protoc_insertion_point(field_get:Commands.RenameClassAttribute)
  return renameclassattribute_ != NULL ? *renameclassattribute_
                         : *::RenameClassAttribute::internal_default_instance();
}
inline ::RenameClassAttribute* Commands::mutable_renameclassattribute() {
  
  if (renameclassattribute_ == NULL) {
    renameclassattribute_ = new ::RenameClassAttribute;
  }
  // @@protoc_insertion_point(field_mutable:Commands.RenameClassAttribute)
  return renameclassattribute_;
}
inline ::RenameClassAttribute* Commands::release_renameclassattribute() {
  // @@protoc_insertion_point(field_release:Commands.RenameClassAttribute)
  
  ::RenameClassAttribute* temp = renameclassattribute_;
  renameclassattribute_ = NULL;
  return temp;
}
inline void Commands::set_allocated_renameclassattribute(::RenameClassAttribute* renameclassattribute) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.RenameClassAttribute)
}

// .RemoveClassAttribute RemoveClassAttribute = 16;
inline bool Commands::has_removeclassattribute() const {
  return this != internal_default_instance() && removeclassattribute_ != NULL;
}
inline void Commands::clear_removeclassattribute() {
  if (GetArenaNoVirtual() == NULL && removeclassattribute_ != NULL) delete removeclassattribute_;
  removeclassattribute_ = NULL;
}
inline const ::RemoveClassAttribute& Commands::removeclassattribute() const {
  // @@protoc_insertion_point(field_get:Commands.RemoveClassAttribute)
  return removeclassattribute_ != NULL ? *removeclassattribute_
                         : *::RemoveClassAttribute::internal_default_instance();
}
inline ::RemoveClassAttribute* Commands::mutable_removeclassattribute() {
  
  if (removeclassattribute_ == NULL) {
    removeclassattribute_ = new ::RemoveClassAttribute;
  }
  // @@protoc_insertion_point(field_mutable:Commands.RemoveClassAttribute)
  return removeclassattribute_;
}
inline ::RemoveClassAttribute* Commands::release_removeclassattribute() {
  // @@protoc_insertion_point(field_release:Commands.RemoveClassAttribute)
  
  ::RemoveClassAttribute* temp = removeclassattribute_;
  removeclassattribute_ = NULL;
  return temp;
}
inline void Commands::set_allocated_removeclassattribute(::RemoveClassAttribute* removeclassattribute) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.RemoveClassAttribute)
}

// .AddClassMemberFunction AddClassMemberFunction = 17;
inline bool Commands::has_addclassmemberfunction() const {
  return this != internal_default_instance() && addclassmemberfunction_ != NULL;
}
inline void Commands::clear_addclassmemberfunction() {
  if (GetArenaNoVirtual() == NULL && addclassmemberfunction_ != NULL) delete addclassmemberfunction_;
  addclassmemberfunction_ = NULL;
}
inline const ::AddClassMemberFunction& Commands::addclassmemberfunction() const {
  // @@protoc_insertion_point(field_get:Commands.AddClassMemberFunction)
  return addclassmemberfunction_ != NULL ? *addclassmemberfunction_
                         : *::AddClassMemberFunction::internal_default_instance();
}
inline ::AddClassMemberFunction* Commands::mutable_addclassmemberfunction() {
  
  if (addclassmemberfunction_ == NULL) {
    addclassmemberfunction_ = new ::AddClassMemberFunction;
  }
  // @@protoc_insertion_point(field_mutable:Commands.AddClassMemberFunction)
  return addclassmemberfunction_;
}
inline ::AddClassMemberFunction* Commands::release_addclassmemberfunction() {
  // @@protoc_insertion_point(field_release:Commands.AddClassMemberFunction)
  
  ::AddClassMemberFunction* temp = addclassmemberfunction_;
  addclassmemberfunction_ = NULL;
  return temp;
}
inline void Commands::set_allocated_addclassmemberfunction(::AddClassMemberFunction* addclassmemberfunction) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.AddClassMemberFunction)
}

// .SetListType SetListType = 18;
inline bool Commands::has_setlisttype() const {
  return this != internal_default_instance() && setlisttype_ != NULL;
}
inline void Commands::clear_setlisttype() {
  if (GetArenaNoVirtual() == NULL && setlisttype_ != NULL) delete setlisttype_;
  setlisttype_ = NULL;
}
inline const ::SetListType& Commands::setlisttype() const {
  // @@protoc_insertion_point(field_get:Commands.SetListType)
  return setlisttype_ != NULL ? *setlisttype_
                         : *::SetListType::internal_default_instance();
}
inline ::SetListType* Commands::mutable_setlisttype() {
  
  if (setlisttype_ == NULL) {
    setlisttype_ = new ::SetListType;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetListType)
  return setlisttype_;
}
inline ::SetListType* Commands::release_setlisttype() {
  // @@protoc_insertion_point(field_release:Commands.SetListType)
  
  ::SetListType* temp = setlisttype_;
  setlisttype_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setlisttype(::SetListType* setlisttype) {
  delete setlisttype_;
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetListType)
}

// .CallFunction CallFunction = 19;
inline bool Commands::has_callfunction() const {
  return this != internal_default_instance() && callfunction_ != NULL;
}
inline void Commands::clear_callfunction() {
  if (GetArenaNoVirtual() == NULL && callfunction_ != NULL) delete callfunction_;
  callfunction_ = NULL;
}
inline const ::CallFunction& Commands::callfunction() const {
  // @@protoc_insertion_point(field_get:Commands.CallFunction)
  return callfunction_ != NULL ? *callfunction_
                         : *::CallFunction::internal_default_instance();
}
inline ::CallFunction* Commands::mutable_callfunction() {
  
  if (callfunction_ == NULL) {
    callfunction_ = new ::CallFunction;
  }
  // @@protoc_insertion_point(field_mutable:Commands.CallFunction)
  return callfunction_;
}
inline ::CallFunction* Commands::release_callfunction() {
  // @@protoc_insertion_point(field_release:Commands.CallFunction)
  
  ::CallFunction* temp = callfunction_;
  callfunction_ = NULL;
  return temp;
}
inline void Commands::set_allocated_callfunction(::CallFunction* callfunction) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.CallFunction)
}

// .SetFunctionParameter SetFunctionParameter = 20;
inline bool Commands::has_setfunctionparameter() const {
  return this != internal_default_instance() && setfunctionparameter_ != NULL;
}
inline void Commands::clear_setfunctionparameter() {
  if (GetArenaNoVirtual() == NULL && setfunctionparameter_ != NULL) delete setfunctionparameter_;
  setfunctionparameter_ = NULL;
}
inline const ::SetFunctionParameter& Commands::setfunctionparameter() const {
  // @@protoc_insertion_point(field_get:Commands.SetFunctionParameter)
  return setfunctionparameter_ != NULL ? *setfunctionparameter_
                         : *::SetFunctionParameter::internal_default_instance();
}
inline ::SetFunctionParameter* Commands::mutable_setfunctionparameter() {
  
  if (setfunctionparameter_ == NULL) {
    setfunctionparameter_ = new ::SetFunctionParameter;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetFunctionParameter)
  return setfunctionparameter_;
}
inline ::SetFunctionParameter* Commands::release_setfunctionparameter() {
  // @@protoc_insertion_point(field_release:Commands.SetFunctionParameter)
  
  ::SetFunctionParameter* temp = setfunctionparameter_;
  setfunctionparameter_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setfunctionparameter(::SetFunctionParameter* setfunctionparameter) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetFunctionParameter)
}

// .SetFunctionReturn SetFunctionReturn = 21;
inline bool Commands::has_setfunctionreturn() const {
  return this != internal_default_instance() && setfunctionreturn_ != NULL;
}
inline void Commands::clear_setfunctionreturn() {
  if (GetArenaNoVirtual() == NULL && setfunctionreturn_ != NULL) delete setfunctionreturn_;
  setfunctionreturn_ = NULL;
}
inline const ::SetFunctionReturn& Commands::setfunctionreturn() const {
  // @@protoc_insertion_point(field_get:Commands.SetFunctionReturn)
  return setfunctionreturn_ != NULL ? *setfunctionreturn_
                         : *::SetFunctionReturn::internal_default_instance();
}
inline ::SetFunctionReturn* Commands::mutable_setfunctionreturn() {
  
  if (setfunctionreturn_ == NULL) {
    setfunctionreturn_ = new ::SetFunctionReturn;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetFunctionReturn)
  return setfunctionreturn_;
}
inline ::SetFunctionReturn* Commands::release_setfunctionreturn() {
  // @@protoc_insertion_point(field_release:Commands.SetFunctionReturn)
  
  ::SetFunctionReturn* temp = setfunctionreturn_;
  setfunctionreturn_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setfunctionreturn(::SetFunctionReturn* setfunctionreturn) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetFunctionReturn)
}

// .SetFunctionEntryPoint SetFunctionEntryPoint = 22;
inline bool Commands::has_setfunctionentrypoint() const {
  return this != internal_default_instance() && setfunctionentrypoint_ != NULL;
}
inline void Commands::clear_setfunctionentrypoint() {
  if (GetArenaNoVirtual() == NULL && setfunctionentrypoint_ != NULL) delete setfunctionentrypoint_;
  setfunctionentrypoint_ = NULL;
}
inline const ::SetFunctionEntryPoint& Commands::setfunctionentrypoint() const {
  // @@protoc_insertion_point(field_get:Commands.SetFunctionEntryPoint)
  return setfunctionentrypoint_ != NULL ? *setfunctionentrypoint_
                         : *::SetFunctionEntryPoint::internal_default_instance();
}
inline ::SetFunctionEntryPoint* Commands::mutable_setfunctionentrypoint() {
  
  if (setfunctionentrypoint_ == NULL) {
    setfunctionentrypoint_ = new ::SetFunctionEntryPoint;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetFunctionEntryPoint)
  return setfunctionentrypoint_;
}
inline ::SetFunctionEntryPoint* Commands::release_setfunctionentrypoint() {
  // @@protoc_insertion_point(field_release:Commands.SetFunctionEntryPoint)
  
  ::SetFunctionEntryPoint* temp = setfunctionentrypoint_;
  setfunctionentrypoint_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setfunctionentrypoint(::SetFunctionEntryPoint* setfunctionentrypoint) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetFunctionEntryPoint)
}

// .RemoveFunctionInstruction RemoveFunctionInstruction = 23;
inline bool Commands::has_removefunctioninstruction() const {
  return this != internal_default_instance() && removefunctioninstruction_ != NULL;
}
inline void Commands::clear_removefunctioninstruction() {
...
inline const ::RemoveFunctionInstruction& Commands::removefunctioninstruction() const {
  // @@protoc_insertion_point(field_get:Commands.RemoveFunctionInstruction)
  return removefunctioninstruction_ != NULL ? *removefunctioninstruction_
                         : *::RemoveFunctionInstruction::internal_default_instance();
}
inline ::RemoveFunctionInstruction* Commands::mutable_removefunctioninstruction() {
  
  if (removefunctioninstruction_ == NULL) {
    removefunctioninstruction_ = new ::RemoveFunctionInstruction;
  }
  // @@protoc_insertion_point(field_mutable:Commands.RemoveFunctionInstruction)
  return removefunctioninstruction_;
}
inline ::RemoveFunctionInstruction* Commands::release_removefunctioninstruction() {
  // @@protoc_insertion_point(field_release:Commands.RemoveFunctionInstruction)
  
  ::RemoveFunctionInstruction* temp = removefunctioninstruction_;
  removefunctioninstruction_ = NULL;
  return temp;
}
inline void Commands::set_allocated_removefunctioninstruction(::RemoveFunctionInstruction* removefunctioninstruction) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.RemoveFunctionInstruction)
}

// .AddInstruction AddInstruction = 24;
inline bool Commands::has_addinstruction() const {
  return this != internal_default_instance() && addinstruction_ != NULL;
}
inline void Commands::clear_addinstruction() {
  if (GetArenaNoVirtual() == NULL && addinstruction_ != NULL) delete addinstruction_;
  addinstruction_ = NULL;
}
inline const ::AddInstruction& Commands::addinstruction() const {
  // @@protoc_insertion_point(field_get:Commands.AddInstruction)
  return addinstruction_ != NULL ? *addinstruction_
                         : *::AddInstruction::internal_default_instance();
}
inline ::AddInstruction* Commands::mutable_addinstruction() {
  
  if (addinstruction_ == NULL) {
    addinstruction_ = new ::AddInstruction;
  }
  // @@protoc_insertion_point(field_mutable:Commands.AddInstruction)
  return addinstruction_;
}
inline ::AddInstruction* Commands::release_addinstruction() {
  // @@protoc_insertion_point(field_release:Commands.AddInstruction)
  
  ::AddInstruction* temp = addinstruction_;
  addinstruction_ = NULL;
  return temp;
}
inline void Commands::set_allocated_addinstruction(::AddInstruction* addinstruction) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.AddInstruction)
}

// .LinkInstructionExecution LinkInstructionExecution = 25;
inline bool Commands::has_linkinstructionexecution() const {
  return this != internal_default_instance() && linkinstructionexecution_ != NULL;
}
inline void Commands::clear_linkinstructionexecution() {
  if (GetArenaNoVirtual() == NULL && linkinstructionexecution_ != NULL) delete linkinstructionexecution_;
  linkinstructionexecution_ = NULL;
}
inline const ::LinkInstructionExecution& Commands::linkinstructionexecution() const {
  // @@protoc_insertion_point(field_get:Commands.LinkInstructionExecution)
  return linkinstructionexecution_ != NULL ? *linkinstructionexecution_
                         : *::LinkInstructionExecution::internal_default_instance();
}
inline ::LinkInstructionExecution* Commands::mutable_linkinstructionexecution() {
  
  if (linkinstructionexecution_ == NULL) {
    linkinstructionexecution_ = new ::LinkInstructionExecution;
  }
  // @@protoc_insertion_point(field_mutable:Commands.LinkInstructionExecution)
  return linkinstructionexecution_;
}
inline ::LinkInstructionExecution* Commands::release_linkinstructionexecution() {
  // @@protoc_insertion_point(field_release:Commands.LinkInstructionExecution)
  
  ::LinkInstructionExecution* temp = linkinstructionexecution_;
  linkinstructionexecution_ = NULL;
  return temp;
}
inline void Commands::set_allocated_linkinstructionexecution(::LinkInstructionExecution* linkinstructionexecution) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.LinkInstructionExecution)
}

// .LinkInstructionData LinkInstructionData = 26;
inline bool Commands::has_linkinstructiondata() const {
  return this != internal_default_instance() && linkinstructiondata_ != NULL;
}
inline void Commands::clear_linkinstructiondata() {
  if (GetArenaNoVirtual() == NULL && linkinstructiondata_ != NULL) delete linkinstructiondata_;
  linkinstructiondata_ = NULL;
}
inline const ::LinkInstructionData& Commands::linkinstructiondata() const {
  // @@protoc_insertion_point(field_get:Commands.LinkInstructionData)
  return linkinstructiondata_ != NULL ? *linkinstructiondata_
                         : *::LinkInstructionData::internal_default_instance();
}
inline ::LinkInstructionData* Commands::mutable_linkinstructiondata() {
  
  if (linkinstructiondata_ == NULL) {
    linkinstructiondata_ = new ::LinkInstructionData;
  }
  // @@protoc_insertion_point(field_mutable:Commands.LinkInstructionData)
  return linkinstructiondata_;
}
inline ::LinkInstructionData* Commands::release_linkinstructiondata() {
  // @@protoc_insertion_point(field_release:Commands.LinkInstructionData)
  
  ::LinkInstructionData* temp = linkinstructiondata_;
  linkinstructiondata_ = NULL;
  return temp;
}
inline void Commands::set_allocated_linkinstructiondata(::LinkInstructionData* linkinstructiondata) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.LinkInstructionData)
}

// .SetInstructionInputValue SetInstructionInputValue = 27;
inline bool Commands::has_setinstructioninputvalue() const {
  return this != internal_default_instance() && setinstructioninputvalue_ != NULL;
}
inline void Commands::clear_setinstructioninputvalue() {
  if (GetArenaNoVirtual() == NULL && setinstructioninputvalue_ != NULL) delete setinstructioninputvalue_;
  setinstructioninputvalue_ = NULL;
}
inline const ::SetInstructionInputValue& Commands::setinstructioninputvalue() const {
  // @@protoc_insertion_point(field_get:Commands.SetInstructionInputValue)
  return setinstructioninputvalue_ != NULL ? *setinstructioninputvalue_
                         : *::SetInstructionInputValue::internal_default_instance();
}
inline ::SetInstructionInputValue* Commands::mutable_setinstructioninputvalue() {
  
  if (setinstructioninputvalue_ == NULL) {
    setinstructioninputvalue_ = new ::SetInstructionInputValue;
  }
  // @@protoc_insertion_point(field_mutable:Commands.SetInstructionInputValue)
  return setinstructioninputvalue_;
}
inline ::SetInstructionInputValue* Commands::release_setinstructioninputvalue() {
  // @@protoc_insertion_point(field_release:Commands.SetInstructionInputValue)
  
  ::SetInstructionInputValue* temp = setinstructioninputvalue_;
  setinstructioninputvalue_ = NULL;
  return temp;
}
inline void Commands::set_allocated_setinstructioninputvalue(::SetInstructionInputValue* setinstructioninputvalue) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.SetInstructionInputValue)
}

// .UnlinkInstructionFlow UnlinkInstructionFlow = 28;
inline bool Commands::has_unlinkinstructionflow() const {
  return this != internal_default_instance() && unlinkinstructionflow_ != NULL;
}
inline void Commands::clear_unlinkinstructionflow() {
  if (GetArenaNoVirtual() == NULL && unlinkinstructionflow_ != NULL) delete unlinkinstructionflow_;
  unlinkinstructionflow_ = NULL;
}
inline const ::UnlinkInstructionFlow& Commands::unlinkinstructionflow() const {
  // @@protoc_insertion_point(field_get:Commands.UnlinkInstructionFlow)
  return unlinkinstructionflow_ != NULL ? *unlinkinstructionflow_
                         : *::UnlinkInstructionFlow::internal_default_instance();
}
inline ::UnlinkInstructionFlow* Commands::mutable_unlinkinstructionflow() {
  
  if (unlinkinstructionflow_ == NULL) {
    unlinkinstructionflow_ = new ::UnlinkInstructionFlow;
  }
  // @@protoc_insertion_point(field_mutable:Commands.UnlinkInstructionFlow)
  return unlinkinstructionflow_;
}
inline ::UnlinkInstructionFlow* Commands::release_unlinkinstructionflow() {
  // @@protoc_insertion_point(field_release:Commands.UnlinkInstructionFlow)
  
  ::UnlinkInstructionFlow* temp = unlinkinstructionflow_;
  unlinkinstructionflow_ = NULL;
  return temp;
}
inline void Commands::set_allocated_unlinkinstructionflow(::UnlinkInstructionFlow* unlinkinstructionflow) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.UnlinkInstructionFlow)
}

// .UnlinkInstructionInput UnlinkInstructionInput = 29;
inline bool Commands::has_unlinkinstructioninput() const {
  return this != internal_default_instance() && unlinkinstructioninput_ != NULL;
}
inline void Commands::clear_unlinkinstructioninput() {
  if (GetArenaNoVirtual() == NULL && unlinkinstructioninput_ != NULL) delete unlinkinstructioninput_;
  unlinkinstructioninput_ = NULL;
}
inline const ::UnlinkInstructionInput& Commands::unlinkinstructioninput() const {
  // @@protoc_insertion_point(field_get:Commands.UnlinkInstructionInput)
  return unlinkinstructioninput_ != NULL ? *unlinkinstructioninput_
                         : *::UnlinkInstructionInput::internal_default_instance();
}
inline ::UnlinkInstructionInput* Commands::mutable_unlinkinstructioninput() {
  
  if (unlinkinstructioninput_ == NULL) {
    unlinkinstructioninput_ = new ::UnlinkInstructionInput;
  }
  // @@protoc_insertion_point(field_mutable:Commands.UnlinkInstructionInput)
  return unlinkinstructioninput_;
}
inline ::UnlinkInstructionInput* Commands::release_unlinkinstructioninput() {
  // @@protoc_insertion_point(field_release:Commands.UnlinkInstructionInput)
  
  ::UnlinkInstructionInput* temp = unlinkinstructioninput_;
  unlinkinstructioninput_ = NULL;
  return temp;
}
inline void Commands::set_allocated_unlinkinstructioninput(::UnlinkInstructionInput* unlinkinstructioninput) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Commands.UnlinkInstructionInput)
}
...
// .Declare Command = 1;
inline bool EntityDeclared::has_command() const {
  return this != internal_default_instance() && command_ != NULL;
}
inline void EntityDeclared::clear_command() {
  if (GetArenaNoVirtual() == NULL && command_ != NULL) delete command_;
  command_ = NULL;
}
inline const ::Declare& EntityDeclared::command() const {
  // @@protoc_insertion_point(field_get:EntityDeclared.Command)
  return command_ != NULL ? *command_
                         : *::Declare::internal_default_instance();
}
inline ::Declare* EntityDeclared::mutable_command() {
  
  if (command_ == NULL) {
    command_ = new ::Declare;
  }
  // @@protoc_insertion_point(field_mutable:EntityDeclared.Command)
  return command_;
}
inline ::Declare* EntityDeclared::release_command() {
  // @@protoc_insertion_point(field_release:EntityDeclared.Command)
  
  ::Declare* temp = command_;
  command_ = NULL;
  return temp;
}
inline void EntityDeclared::set_allocated_command(::Declare* command) {
  delete command_;
  command_ = command;
  if (command) {
  ...
  // @@protoc_insertion_point(field_set_allocated:EntityDeclared.Command)
}

// uint32 EntityID = 2;
inline void EntityDeclared::clear_entityid() {
  entityid_ = 0u;
}
inline ::google::protobuf::uint32 EntityDeclared::entityid() const {
  // @@protoc_insertion_point(field_get:EntityDeclared.EntityID)
  return entityid_;
}
inline void EntityDeclared::set_entityid(::google::protobuf::uint32 value) {
  
  entityid_ = value;
  // @@protoc_insertion_point(field_set:EntityDeclared.EntityID)
}
...
// .Commands Commands = 1;
inline bool ProtoData::has_commands() const {
  return this != internal_default_instance() && commands_ != NULL;
}
inline void ProtoData::clear_commands() {
  if (GetArenaNoVirtual() == NULL && commands_ != NULL) delete commands_;
  commands_ = NULL;
}
inline const ::Commands& ProtoData::commands() const {
  // @@protoc_insertion_point(field_get:ProtoData.Commands)
  return commands_ != NULL ? *commands_
                         : *::Commands::internal_default_instance();
}
inline ::Commands* ProtoData::mutable_commands() {
  
  if (commands_ == NULL) {
    commands_ = new ::Commands;
  }
  // @@protoc_insertion_point(field_mutable:ProtoData.Commands)
  return commands_;
}
inline ::Commands* ProtoData::release_commands() {
  // @@protoc_insertion_point(field_release:ProtoData.Commands)
  
  ::Commands* temp = commands_;
  commands_ = NULL;
  return temp;
}
inline void ProtoData::set_allocated_commands(::Commands* commands) {
  delete commands_;
  commands_ = commands;
  if (commands) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ProtoData.Commands)
}

// .Replies Replies = 2;
inline bool ProtoData::has_replies() const {
  return this != internal_default_instance() && replies_ != NULL;
}
inline void ProtoData::clear_replies() {
  if (GetArenaNoVirtual() == NULL && replies_ != NULL) delete replies_;
  replies_ = NULL;
}
inline const ::Replies& ProtoData::replies() const {
  // @@protoc_insertion_point(field_get:ProtoData.Replies)
  return replies_ != NULL ? *replies_
                         : *::Replies::internal_default_instance();
}
inline ::Replies* ProtoData::mutable_replies() {
  
  if (replies_ == NULL) {
    replies_ = new ::Replies;
  }
  // @@protoc_insertion_point(field_mutable:ProtoData.Replies)
  return replies_;
}
inline ::Replies* ProtoData::release_replies() {
  // @@protoc_insertion_point(field_release:ProtoData.Replies)
  
  ::Replies* temp = replies_;
  replies_ = NULL;
  return temp;
}
inline void ProtoData::set_allocated_replies(::Replies* replies) {
  delete replies_;
  replies_ = replies;
  if (replies) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ProtoData.Replies)
}
...
// .EntityDeclared EntityDeclared = 1;
inline bool Replies::has_entitydeclared() const {
  return this != internal_default_instance() && entitydeclared_ != NULL;
}
inline void Replies::clear_entitydeclared() {
  if (GetArenaNoVirtual() == NULL && entitydeclared_ != NULL) delete entitydeclared_;
  entitydeclared_ = NULL;
}
inline const ::EntityDeclared& Replies::entitydeclared() const {
  // @@protoc_insertion_point(field_get:Replies.EntityDeclared)
  return entitydeclared_ != NULL ? *entitydeclared_
                         : *::EntityDeclared::internal_default_instance();
}
inline ::EntityDeclared* Replies::mutable_entitydeclared() {
  
  if (entitydeclared_ == NULL) {
    entitydeclared_ = new ::EntityDeclared;
  }
  // @@protoc_insertion_point(field_mutable:Replies.EntityDeclared)
  return entitydeclared_;
}
inline ::EntityDeclared* Replies::release_entitydeclared() {
  // @@protoc_insertion_point(field_release:Replies.EntityDeclared)
  
  ::EntityDeclared* temp = entitydeclared_;
  entitydeclared_ = NULL;
  return temp;
}
inline void Replies::set_allocated_entitydeclared(::EntityDeclared* entitydeclared) {
  delete entitydeclared_;
  entitydeclared_ = entitydeclared;
  if (entitydeclared) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_set_allocated:Replies.EntityDeclared)
}
...
inline void SetInstructionInputValue::clear_inputvalue() {
  inputvalue_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& SetInstructionInputValue::inputvalue() const {
  // @@protoc_insertion_point(field_get:SetInstructionInputValue.InputValue)
  return inputvalue_.GetNoArena();
}
inline void SetInstructionInputValue::set_inputvalue(const ::std::string& value) {
  
  inputvalue_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:SetInstructionInputValue.InputValue)
}
#if LANG_CXX11
inline void SetInstructionInputValue::set_inputvalue(::std::string&& value) {
  
  inputvalue_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:SetInstructionInputValue.InputValue)
}
#endif
inline void SetInstructionInputValue::set_inputvalue(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  inputvalue_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:SetInstructionInputValue.InputValue)
}
inline void SetInstructionInputValue::set_inputvalue(const char* value, size_t size) {
  
  inputvalue_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:SetInstructionInputValue.InputValue)
}
inline ::std::string* SetInstructionInputValue::mutable_inputvalue() {
  
  // @@protoc_insertion_point(field_mutable:SetInstructionInputValue.InputValue)
  return inputvalue_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* SetInstructionInputValue::release_inputvalue() {
  // @@protoc_insertion_point(field_release:SetInstructionInputValue.InputValue)
  
  return inputvalue_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void SetInstructionInputValue::set_allocated_inputvalue(::std::string* inputvalue) {
  if (inputvalue != NULL) {
    
  } else {
    
  }
  inputvalue_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), inputvalue);
...
#endif  // PROTOBUF_core_5freply_2eproto__INCLUDED
