...
class QCanvas : public QQuickItem
{
    ...
    Q_PROPERTY(duly_gui::models::QGrid *grid READ grid WRITE setGrid NOTIFY gridChanged)
...
{
    Q_OBJECT
    Q_PROPERTY(duly_gui::models::QBorder *border READ border WRITE setBorder NOTIFY borderChanged)
    Q_PROPERTY(QColor color READ color WRITE setColor NOTIFY colorChanged)
...
class QNodes : public QQuickItem
{
    ...
    Q_PROPERTY(duly_gui::models::QNode *genericNode READ genericNode WRITE setGenericNode NOTIFY genericNodeChanged)
    Q_PROPERTY(duly_gui::models::QNode *intNode READ intNode WRITE setIntNode NOTIFY intNodeChanged)
    Q_PROPERTY(duly_gui::models::QNode *stringNode READ stringNode WRITE setStringNode NOTIFY stringNodeChanged)
    Q_PROPERTY(duly_gui::models::QNode *boolNode READ boolNode WRITE setBoolNode NOTIFY boolNodeChanged)
    Q_PROPERTY(duly_gui::models::QNode *functionNode READ functionNode WRITE setFunctionNode NOTIFY functionNodeChanged)
    Q_PROPERTY(duly_gui::models::QNode *classNode READ classNode WRITE setClassNode NOTIFY classNodeChanged)
    Q_PROPERTY(duly_gui::models::QNode *listNode READ listNode WRITE setListNode NOTIFY listNodeChanged)
...
class QDeclarationView : public QQuickItem
{
    ...
    Q_PROPERTY(qreal radius READ radius WRITE setRadius NOTIFY radiusChanged)
    Q_PROPERTY(duly_gui::models::QBorder *border READ border WRITE setBorder NOTIFY borderChanged)
    Q_PROPERTY(duly_gui::models::QDeclaration *declContext READ declContext WRITE setDeclContext NOTIFY declContextChanged)
    Q_PROPERTY(duly_gui::models::QDeclaration *declClass READ declClass WRITE setDeclClass NOTIFY declClassChanged)
    Q_PROPERTY(duly_gui::models::QDeclaration *declFunction READ declFunction WRITE setDeclFunction NOTIFY declFunctionChanged)
    Q_PROPERTY(duly_gui::models::QDeclaration *declVariable READ declVariable WRITE setDeclVariable NOTIFY declVariableChanged)
...
class MenuSettings : public QQuickItem
{
    Q_OBJECT
    Q_PROPERTY(duly_gui::models::QBorder *border READ border WRITE setBorder NOTIFY borderChanged)
    Q_PROPERTY(duly_gui::models::QBackground *background READ background WRITE setBackground NOTIFY backgroundChanged)
public:
...
class DulySettingsModel : public QQuickItem
{
    Q_OBJECT
    Q_PROPERTY(duly_gui::models::QBackground *background READ background WRITE setBackground NOTIFY backgroundChanged)
    Q_PROPERTY(duly_gui::models::MenuSettings *menu READ menu WRITE setMenu NOTIFY menuChanged)
    Q_PROPERTY(QColor shadowColor READ shadowColor WRITE setShadowColor NOTIFY shadowColorChanged)
    Q_PROPERTY(duly_gui::models::QBorder *border READ border WRITE setBorder NOTIFY borderChanged)
    Q_PROPERTY(duly_gui::models::QCanvas *canvas READ canvas WRITE setCanvas NOTIFY canvasChanged)
    Q_PROPERTY(duly_gui::models::QNodes *nodes READ nodes WRITE setNodes NOTIFY nodesChanged)
    Q_PROPERTY(duly_gui::models::QDeclarationView *declarationView READ declarationView WRITE setDeclarationView NOTIFY declarationViewChanged)
    Q_PROPERTY(duly_gui::models::QFontSettings *font READ font WRITE setFont NOTIFY fontChanged)
    Q_PROPERTY(duly_gui::models::QTextSettings *text READ text WRITE setText NOTIFY textChanged)
