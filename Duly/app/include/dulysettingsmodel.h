...
Q_OBJECT
	...
	Q_PROPERTY(QGrid *grid READ grid WRITE setGrid NOTIFY gridChanged)
...
Q_OBJECT
	...
	Q_PROPERTY(QNode *genericNode READ genericNode WRITE setGenericNode NOTIFY genericNodeChanged)
	Q_PROPERTY(QNode *intNode READ intNode WRITE setIntNode NOTIFY intNodeChanged)
	Q_PROPERTY(QNode *stringNode READ stringNode WRITE setStringNode NOTIFY stringNodeChanged)
	Q_PROPERTY(QNode *boolNode READ boolNode WRITE setBoolNode NOTIFY boolNodeChanged)
	Q_PROPERTY(QNode *functionNode READ functionNode WRITE setFunctionNode NOTIFY functionNodeChanged)
	Q_PROPERTY(QNode *classNode READ classNode WRITE setClassNode NOTIFY classNodeChanged)
	Q_PROPERTY(QNode *listNode READ listNode WRITE setListNode NOTIFY listNodeChanged)
...
Q_OBJECT
	...
	Q_PROPERTY(qreal radius READ radius WRITE setRadius NOTIFY radiusChanged)
	Q_PROPERTY(QBorder *border READ border WRITE setBorder NOTIFY borderChanged)
	Q_PROPERTY(QDeclaration *declContext READ declContext WRITE setDeclContext NOTIFY declContextChanged)
	Q_PROPERTY(QDeclaration *declClass READ declClass WRITE setDeclClass NOTIFY declClassChanged)
	Q_PROPERTY(QDeclaration *declFunction READ declFunction WRITE setDeclFunction NOTIFY declFunctionChanged)
	Q_PROPERTY(QDeclaration *declVariable READ declVariable WRITE setDeclVariable NOTIFY declVariableChanged)
