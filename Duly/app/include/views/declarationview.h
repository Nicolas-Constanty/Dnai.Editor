...
namespace duly_gui
{
	namespace views
	{
		...
		{
			Q_OBJECT
            Q_PROPERTY(DeclarationType type READ type WRITE setType NOTIFY typeChanged)
		...
		signals:
            void typeChanged(const DeclarationType type);
		...
		public:
            void setType(const DeclarationType type);
		...
		public:
            DeclarationType type() const { return m_type; }
